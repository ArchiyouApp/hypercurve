...
fn bezier_boolean_uniform_ownership_expands_operand_locations_to_keyed_facts() {
    ...
    let location_validated = location_report.validate(&schedule);
    assert_eq!(location_validated, validated);
}
...
fn bezier_boolean_operand_locations_expand_non_uniform_locator_outputs() {
    ...
    let location_validated = location_report.validate(&schedule);
    assert_eq!(location_validated, report.validate(&schedule));
...
fn bezier_boolean_overlap_bridges_override_coincident_tangent_ties() {
    ...
    let traversal =
        BezierBooleanLoopGraphTraversalReport2::from_certified_walk_graph_facts(&plan, 0, 1);
    let tangents = vec![
        endpoint_tangents(point(0, 0), point(1, 0)),
        endpoint_tangents(point(1, 0), point(0, 0)),
        endpoint_tangents(point(0, 0), point(1, 0)),
    ...
    let overlaps = BezierBooleanOverlapResolutionReport2::from_overlap_events(
        &[hypercurve::BezierBooleanOverlapEvent2 {
            first_range: ParamRange::new(Real::zero(), Real::one()),
            second_range: ParamRange::new(Real::zero(), Real::one()),
        }],
        &policy(),
    )
    ...
    let tangent_only = BezierBooleanLoopGraphMultiCycleWalkReport2::from_fragment_endpoint_tangents(
        &traversal,
        &plan,
        &tangents,
        &[],
    ...
    assert_eq!(bridged.cycle_start_indices, vec![0, 1]);
    assert_eq!(bridged.cycle_step_counts, vec![2, 2]);
    assert_eq!(bridged.walk_indices, vec![0, 3, 1, 2]);
}
...
fn bezier_boolean_overlap_bridges_block_stale_and_discontinuous_bridges() {
    ...
    let tangents = vec![
        endpoint_tangents(point(0, 0), point(1, 0)),
        endpoint_tangents(point(2, 0), point(3, 0)),
        endpoint_tangents(point(1, 0), point(0, 0)),
    ];
    let overlaps = BezierBooleanOverlapResolutionReport2::from_overlap_events(
        &[hypercurve::BezierBooleanOverlapEvent2 {
...
#[test]
fn bezier_boolean_quadratic_loop_locator_derives_curved_nested_containment() {
    let outer = vec![
        QuadraticBezier2::new(point(0, 0), point(5, -2), point(10, 0)),
        QuadraticBezier2::new(point(10, 0), point(12, 5), point(10, 10)),
        QuadraticBezier2::new(point(10, 10), point(5, 12), point(0, 10)),
        QuadraticBezier2::new(point(0, 10), point(-2, 5), point(0, 0)),
    ];
    let inner = vec![
        QuadraticBezier2::new(point(2, 2), point(3, 1), point(4, 2)),
        QuadraticBezier2::new(point(4, 2), point(5, 3), point(4, 4)),
        QuadraticBezier2::new(point(4, 4), point(3, 5), point(2, 4)),
        QuadraticBezier2::new(point(2, 4), point(1, 3), point(2, 2)),
    ];
...
#[test]
fn bezier_boolean_quadratic_loop_locator_blocks_boundary_and_stale_fragments() {
    let outer = vec![
        QuadraticBezier2::new(point(0, 0), point(5, -2), point(10, 0)),
        QuadraticBezier2::new(point(10, 0), point(12, 5), point(10, 10)),
        QuadraticBezier2::new(point(10, 10), point(5, 12), point(0, 10)),
    ...
    let boundary_probe = vec![
        QuadraticBezier2::new(point(11, 5), point(12, 5), point(12, 6)),
        QuadraticBezier2::new(point(12, 6), point(11, 7), point(11, 5)),
    ];
    ...
    let stale_first = BezierBooleanQuadraticFragmentReport2 {
...
fn bezier_boolean_rational_quadratic_loop_locator_derives_curved_nested_containment() {
    ...
    let closure = BezierBooleanLoopClosureReport2::from_fragment_endpoints(&plan, &endpoints, &[]);
    let output = BezierBooleanOutputLoopReport2::from_loop_closure(&closure);
    let first = BezierBooleanRationalQuadraticFragmentReport2 {
        status: BezierBooleanFragmentConstructionStatus::Ready,
        readiness_status: BezierBooleanConstructionReadinessStatus::Ready,
        source_parameter_count: 0,
        endpoint_parameter_count: 0,
    ...
    let second = BezierBooleanRationalQuadraticFragmentReport2 {
        fragments: Vec::new(),
        ..first.clone()
    };

    let replay = BezierBooleanLoopContainmentQueryResultReport2::from_output_loop_rational_quadratic_fragments(
        &output,
        &first,
        &second,
        &policy(),
...
#[test]
fn bezier_boolean_rational_quadratic_loop_locator_blocks_boundary_and_stale_fragments() {
    let outer = vec![
        RationalQuadraticBezier2::try_unit_end_weights(
            point(0, 0),
            point(5, -2),
    ...
    let boundary = BezierBooleanLoopContainmentQueryResultReport2::from_output_loop_rational_quadratic_fragments(
        &output,
        &first,
        &second,
        &policy(),
    ...
    let stale_first = BezierBooleanRationalQuadraticFragmentReport2 {
        fragments: first.fragments[..4].to_vec(),
        ..first
    };
    let stale = BezierBooleanLoopContainmentQueryResultReport2::from_output_loop_rational_quadratic_fragments(
        &output,
        &stale_first,
        &second,
        &policy(),
...
proptest! {
    ...
    fn generated_bezier_boolean_operand_locations_expand_schedule_order(
        ...
        prop_assert!(location_report.validate(&schedule).is_ready());
    }
