use hypercurve::{
    BulgeVertex2, Classification, Contour2, ContourOperand, ContourSplitMap, CurvePolicy,
    DefaultBackend, Region2, RegionContourKey, RegionContourRole, RegionSide, Scalar,
};
