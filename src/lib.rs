...
pub use curve_string::{
    ...
    CurveStringDeduplicateStage2, CurveStringEndpoint2, CurveStringEndpointConnectionReport2,
    CurveStringEndpointConnectionStatus2, CurveStringExtendReport2, CurveStringExtendResult2,
    CurveStringExtendStage2, CurveStringFilletInputPath2, CurveStringFilletReport2,
    ...
    CurveStringOrderedLinkStepReport2, CurveStringRegionTrimHit2,
    CurveStringRegionTrimIntervalReport2, CurveStringRegionTrimQueryPath2,
