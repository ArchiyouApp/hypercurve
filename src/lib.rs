...
pub use region_nesting::{
    ...
    ExactCurveArrangementOutputRoleCache2, ExactCurveArrangementOutputSegmentKindBucket2,
    ...
    ExactCurveArrangementSourceSegmentFact2, ExactCurveArrangementSplitBlockerCache2,
    ExactCurveArrangementSplitCache2, ExactCurveArrangementSplitCandidateAabbStatus2,
    ExactCurveArrangementSplitCandidatePair2, ExactCurveArrangementSplitIntersectionBucket2,
