...
pub use region_nesting::{
    ...
    ExactCurveArrangementOutputBoundaryCache2, ExactCurveArrangementOutputCache2,
    ...
    ExactCurveArrangementSplitIntersectionRef2, ExactCurveArrangementSplitScheduleBucket2,
    ExactCurveArrangementSplitScheduleBucketCache2, ExactCurveArrangementSplitScheduleCache2,
    ExactCurveArrangementSplitScheduleRef2, ExactCurveWorkspace2,
