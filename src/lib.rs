...
pub use curve_string::{
    ...
    CurveStringChamferResult2, CurveStringConnectReport2, CurveStringCurveTrimHit2,
    CurveStringCurveTrimQueryPath2, CurveStringCurveTrimReport2, CurveStringCurveTrimResult2,
    CurveStringDeduplicateReport2, CurveStringDeduplicateResult2, CurveStringEndpoint2,
