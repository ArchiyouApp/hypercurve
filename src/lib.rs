...
pub use bezier_region::{
    ...
    BezierRetainedCurvedNestingRoleReport2, BezierRetainedLineRegionRoleReport2,
    BezierRetainedRegion2, BezierRetainedRegionLoopRole, BezierRetainedSignedAreaRoleReport2,
};
