...
pub use curve_string::{
    ...
    CurveStringCurveTrimStage2, CurveStringDeduplicateReport2, CurveStringDeduplicateResult2,
    ...
    CurveStringIntersectionReport2, CurveStringIntersectionResult2, CurveStringLineMergeReport2,
    CurveStringLineMergeResult2, CurveStringLineMergeSpanReport2, CurveStringLineMergeStage2,
    CurveStringLinkAttemptReport2, CurveStringLinkAttemptResult2, CurveStringLinkKind2,
    CurveStringLinkOutputSegmentReport2, CurveStringLinkReport2, CurveStringLinkSourceInput2,
