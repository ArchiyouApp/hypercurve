...
pub use curve_string::{
    ...
    CurveStringChamferResult2, CurveStringConnectOutputSegmentReport2, CurveStringConnectReport2,
    CurveStringConnectSource2, CurveStringCurveTrimHit2, CurveStringCurveTrimQueryPath2,
    ...
    CurveStringFilletReport2, CurveStringFilletResult2, CurveStringIntersection,
    ...
    CurveStringLineMergeResult2, CurveStringLineMergeSpanReport2, CurveStringLinkKind2,
