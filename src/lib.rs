...
pub use curve_string::{
    ...
    CurveStringChamferResult2, CurveStringChamferStage2, CurveStringConnectOutputSegmentReport2,
    CurveStringConnectReport2, CurveStringConnectSource2, CurveStringConnectStage2,
    CurveStringCurveTrimHit2, CurveStringCurveTrimQueryPath2, CurveStringCurveTrimReport2,
    CurveStringCurveTrimResult2, CurveStringCurveTrimStage2, CurveStringDeduplicateReport2,
    ...
    CurveStringFilletInputPath2, CurveStringFilletReport2, CurveStringFilletResult2,
    CurveStringFilletStage2, CurveStringIntersection, CurveStringIntersectionPredicatePath2,
