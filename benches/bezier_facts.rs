...
use hypercurve::{
    ...
    BezierBooleanAlgebraicParameterReadinessReport2, BezierBooleanArrangementReadinessReport2,
    BezierBooleanAssemblyReadinessReport2, BezierBooleanBatchHandoffReport2,
    BezierBooleanConstructionReadinessReport2, BezierBooleanCubicFragmentReport2,
    BezierBooleanEmissionPlanReport2, BezierBooleanFragmentLocatorInputReport2,
