...
fn bench_bezier_topology(quadratic: &QuadraticBezier2, cubic: &CubicBezier2) {
    ...
    for _ in 0..iterations {
        ...
        let boolean_scheduler_hypersolve_construction =
            BezierBooleanRootIsolationConstructionReport2::from_hypersolve_range_reports(
                boolean_path_scheduler.clone(),
                &[],
                &[],
                &policy,
            );
        let boolean_scheduler_bernstein_construction =
            BezierBooleanRootIsolationConstructionReport2::from_hypersolve_bernstein_subdivision_reports(
                boolean_path_scheduler.clone(),
                &[],
                &[],
                &policy,
            );
        let boolean_scheduler_algebraic_construction =
            BezierBooleanRootIsolationConstructionReport2::from_hypersolve_algebraic_root_reports(
                boolean_path_scheduler.clone(),
                &[],
                &[],
                &policy,
